...
function check(e) 
{
    ...
    switch (code) 
    {
        case "a": pressing_a=true; break;
        case "d": pressing_d=true; break;
        case "w": pressing_w=true; break;
        case "ArrowLeft": pressing_left=true; break;
        case "ArrowRight": pressing_right=true; break;
        case "Enter": pressing_space=true; 
        if(!started)    
        {
            started=true;
            startround();
        ...
        break;
        case "o": autofire=true; break;
        case "n": nextstage(); break;
        case "p": previousstage(); break;
...
function checkup(e) 
{
    ...
    switch (code) 
    {
        case "a": pressing_a=false; break;
        case "d": pressing_d=false; break;
        case "w": pressing_w=false; break;
        case "ArrowLeft": pressing_left=false; break;
        case "ArrowRight": pressing_right=false; break;
        case "Enter": pressing_space=false; break;
    }
}
...
function drawstart()
{
    ...
    ctx.fillText("Press Enter to Start",0,200);
}
function drawgameover()
{
    erase();
    document.getElementById("gamelevel").innerHTML="Victory!";
