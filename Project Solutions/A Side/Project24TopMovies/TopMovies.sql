CREATE TABLE IF NOT EXISTS TopMovies (
    `year` INT,
    `movie` VARCHAR(45) CHARACTER SET utf8,
    `genre` VARCHAR(9) CHARACTER SET utf8,
    `rating` VARCHAR(5) CHARACTER SET utf8,
    `distributor` VARCHAR(18) CHARACTER SET utf8,
    `totalyear` INT,
    `total2019` INT,
    `totaltickets` INT
);
INSERT INTO TopMovies VALUES
    ...
    (2021,'Spiderman: No Way Home',NULL,'PG-13','Walt Disney',702924074,644570196,73992007);
